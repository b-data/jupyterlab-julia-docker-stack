...
RUN dpkgArch="$(dpkg --print-architecture)" \
  ...
  && sed -i "s|/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin|/opt/TinyTeX/bin/linux:/opt/quarto/bin:/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin|g" /etc/profile \
  && sed -i "s|/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games|/opt/TinyTeX/bin/linux:/opt/quarto/bin:/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games|g" /etc/profile \
  ## Clean up
  && rm -rf /tmp/* \
