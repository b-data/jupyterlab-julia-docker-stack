...
RUN mkdir /opt/code-server \
  ...
  && sed -i "s|/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin|/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin|g" /etc/profile \
  && sed -i "s|/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games|/opt/code-server/bin:$JULIA_PATH/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games|g" /etc/profile \
  ## Clean up
  && rm -rf /tmp/* \
    ${HOME}/.config \
    ${HOME}/.local
